...
function setActive() {
    for(const section of sectionsList) {
        if(nearPortView(section)) {
            ...
            document.querySelector(`a#{section.id}`).classList.add("your-active-class");
            //console.log("the class was added!");
        }
        else {
            section.classList.remove("your-active-class");
            document.querySelector(`a#{section.id}`).classList.remove("your-active-class");
